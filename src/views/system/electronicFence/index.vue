  ...
  <div class="page">
      ...
      <div class="table-box">
          <el-table class="tableList" v-adaptive="{ bottom: 68 }" v-loading="loading" :data="tableList">
              ...
              <el-table-column prop="sbxh" label="设备型号" align="left"></el-table-column>
              <el-table-column prop="fzr" label="负责人员" align="left"></el-table-column>
              <el-table-column prop="lxdh" label="联系电话" align="left" />
              <el-table-column prop="ssqy" label="所属区域" align="left"></el-table-column>
...
const getList = (val?: number) => {
  ...
  fenceApi.getData(queryParams.value).then((res:any) => {
      if (res.success) {
