        ...
        <div class="form">
            <el-form ref="formRef" v-loading="loadForm" :model="form" :inline="true" label-position="left"
                ...
                <el-form-item label="设备类型：" prop="equipmenttype">
                    <el-input v-model="form.equipmenttype" :disabled='true' placeholder="请输入相机编号"></el-input>
                </el-form-item>
                ...
                <el-form-item label="设备品牌：" prop="sbpp">
                    <el-input v-model="form.sbpp" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="设备型号：" prop="sbxh">
                    <el-input v-model="form.sbxh" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="负责人：" prop="fzr">
                    <el-input v-model="form.fzr" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="联系电话：" prop="lxdh">
                    <el-input v-model="form.lxdh" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="所属区域：">
                    <el-radio-group v-model="form.ssqy">
                        <el-radio label="核心区">核心区</el-radio>
                        <el-radio label="实验区">实验区</el-radio>
                        <el-radio label="缓冲区">缓冲区</el-radio>
                    </el-radio-group>
                </el-form-item>
                ...
                <el-form-item label="投运时间：" prop="operationtime">
                    <el-date-picker v-model="form.operationtime" format="YYYY-MM-DD HH:mm:ss" style="width: 100%;" type="datetime" placeholder="请选择" />
                </el-form-item>
                <el-form-item label="温度：" prop="wd">
                    <el-input v-model="form.wd" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="湿度：" prop="sd">
                    <el-input v-model="form.sd" placeholder="请输入"></el-input>
                </el-form-item>
            </el-form>
        </div>
...
const submit = () => {
    formRef.value.validate((valid:any) => {
        if (valid) {
            ...
            try {
                fenceApi.update(query).then((res:any) => {
                    loading.value = false;
                    if (res.success) {
