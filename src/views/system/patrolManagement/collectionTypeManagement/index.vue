        ...
        <div class="search-content">
            <el-form class="queryForm" ref="queryFormRef" :model="queryParams" label-width="auto" :inline="true"
                ...
                <el-form-item label="名称：" prop="typename">
                    <el-input v-model="queryParams.typename" clearable placeholder="请输入"></el-input>
                </el-form-item>
...
const getList = (val?: number) => {
    ...
    collectTypeApi.getDataByPage(queryParams.value).then((res: any) => {
        if (res.success) {
...
const handleDelete = (id: number) => {
    ElMessageBox.confirm("是否确认删除此条数据?", "提示", {
        ...
        .then(() => {
            collectTypeApi.delete({ id: id }).then((res: any) => {
                if (res.success) {
                    ElMessage({
                        type: "success",
                        message: "删除成功",
