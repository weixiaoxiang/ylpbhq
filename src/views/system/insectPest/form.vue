        ...
        <div class="form">
            <el-form ref="formRef" v-loading="loadForm" :model="form" :inline="true" label-position="left"
                ...
                <el-form-item label="设备名称：" prop="equipmentname">
                    <el-input v-model="form.equipmentname" :disabled='true' placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="设备编号：" prop="equipmentid">
                    <el-input v-model="form.equipmentid" :disabled='true' placeholder="请输入"></el-input>
                </el-form-item>
                ...
                <el-form-item label="所属单位：" prop="affiliatedunit">
                    <el-input v-model="form.affiliatedunit" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="设备品牌：" prop="equipmentbrand">
                    <el-input v-model="form.equipmentbrand" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="设备型号：" prop="equipmentmodel">
                    <el-input v-model="form.equipmentmodel" placeholder="请输入"></el-input>
                </el-form-item>
                <el-form-item label="负责人员：" prop="personnel">
                    <el-input v-model="form.personnel" placeholder="请输入"></el-input>
                </el-form-item>
...
const submit = () => {
    formRef.value.validate((valid:any) => {
        if (valid) {
            ...
            try {
                pestsApi.update(query).then((res:any) => {
                    loading.value = false;
                    if (res.success) {
