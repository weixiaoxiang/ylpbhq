...
<template>
  <div class="wrap collaborative-outcomes">
    <!-- <div class="box-header">
      <div class="box-header-title">动物救治</div>
      <div
...
//打开更多页面
const toMore = () => {
  proxy.$mitt.emit("openmore", { typename: "动物救助", typeid: "4" })
}
//查看详情
const toDetail = (item: any) => {
  proxy.$mitt.emit("opendetail", { data: item, txt: "动物救助" })
}
