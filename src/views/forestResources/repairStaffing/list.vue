...
import { GetForestResourcesPreparedListByPage } from "@/api"
...
const getList = async () => {
  const { response } = await GetForestResourcesPreparedListByPage({
    page: page.value,
    ...
    <el-scrollbar height="100%">
      <div class="con">
        <div
          ...
          @click="view(item)"
        >
          <!-- <div class="box-hd">{{ item.mc }}</div> -->
          <div class="box-item">
            <div>
              <span class="name">小斑号:</span>
              <span class="value">{{ item.xbh }}</span>
            </div>
            <div>
              <span class="name">小斑面积:</span>
              <span class="value">{{ item.xbarea + "亩" }}</span>
            </div>
            <div class="grid_item">
              <span class="name">树种名称:</span>
              <span class="value">{{ item.treetype }}</span>
            </div>
            <div class="grid_item">
            ...
            <div class="grid_item">
              <span class="name">预计完成:</span>
              <span class="value">{{ item.yjfinishtime }}</span>
            </div>
          </div>
          <img
            class="checkIcon"
