...
// 病虫害监测
export const bchjInstances = tableAllInstances.filter((item) => item.type === "病虫害监测")
// 旅游景点
export const lyjdInstances = tableAllInstances.filter((item) => item.type === "旅游景点")
