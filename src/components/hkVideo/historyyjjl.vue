      ...
      <div class="dialog-header">
        ...
        <div class="btns">
          ...
          >
            <span class="el-dropdown-link">
              <div
                ...
                @click="handleeldropdownEvent()"
              >
                <img
                  v-if="currentTool === 1"
                  src="/images/geologicalDisaster/bs-close.png"
          ...
          >
            <img
              v-if="currentTool === 2"
              src="/images/geologicalDisaster/xz-close.png"
          ...
          >
            <img
              v-if="currentTool === 4"
              src="/images/geologicalDisaster/qp-close.png"
          ...
          >
            <img
              v-if="currentTool === 3"
              src="/images/geologicalDisaster/jp-close.png"
          ...
          >
            <img
              v-if="currentTool === 5"
              src="/images/geologicalDisaster/gh-on.png"
