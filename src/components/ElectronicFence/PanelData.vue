...
const tabs = ["预警记录", "AI分析记录", "视频监控", "图片抓拍"]
const currentTab = ref<string>(props.tab)
const currentTabParams = ref<any>(props.tabParams)
// 切换tab
const changeTab = (tab: string) => {
  currentTab.value = tab
  if (props.tabParams) {
    currentTabParams.value = null
  }
}
// 组件映射，懒加载
...
const componentMap: any = {
  ...
  图片抓拍: defineAsyncComponent(() => import("./PhotoCapture.vue"))
}
// 计算当前应该显示的组件
